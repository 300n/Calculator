/* export PATH_TO_FX="C:\Users\HP\Downloads\openjfx-25_windows-x64_bin-sdk\javafx-sdk-25\lib"

javac --module-path "$PATH_TO_FX" --add-modules javafx.controls src/MainMenu.java
java --module-path "$PATH_TO_FX" --add-modules javafx.controls -cp src MainMenu */
...
public class MainMenu extends Application {
    ...
    private void updateLayout() {
        ...
        String sharedStyle = "-fx-fill: rgba(255, 255, 255, 1); "
            + "-fx-stroke: rgba(255, 25, 179, 0.8); "
            + "-fx-stroke-width: 3px; "
            + "-fx-effect: dropshadow(gaussian, rgba(255, 25, 179, 0.8), 10, 0.5, 0, 0); "
            + "-fx-arc-width: 20px; "  
            + "-fx-arc-height: 20px;";
        ...
        Image image = new Image("https://imgs.search.brave.com/LCcnVeC4KVS2MOuab6sUffMQ7SxIpTmrjS-YrJk7O8U/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9pLnBp/bmltZy5jb20vb3Jp/Z2luYWxzLzJhLzg3/Lzg3LzJhODc4Nzhh/OTRiNmU3NDFhM2Mx/NzdiMzJjNGRiZGNh/LmpwZw");
        ImagePattern pattern = new ImagePattern(image);

        rect1.setFill(pattern);
        ...
        for (String label : buttonLabels) {
            ...
            String normalStyle = "-fx-background-color: rgb(255, 25, 179, 0.8); "
                    + "-fx-border-color: rgba(255, 0, 225, 1); "
                    ...
                    + "-fx-effect: dropshadow(gaussian, rgba(255, 0, 225, 1), 10, 0.5, 0, 0);";
        
            String pressedStyle = "-fx-background-color: rgba(255, 25, 179, 0.8); "
                    + "-fx-border-color: rgba(255, 25, 179, 0.8); "
                    + "-fx-border-width: " + borderWidth + "px; "
                    + "-fx-border-radius: " + borderRadius + "px; "
                    + "-fx-background-radius: " + (borderRadius + 2) + "px; "
                    + "-fx-font-size: " + fontSize + "px; "
                    + "-fx-font-weight: bold; "
                    + "-fx-text-fill: rgb(255, 25, 179, 0.8); "
                    + "-fx-min-width: " + btnWidth + "px; "
                    + "-fx-max-width: " + btnWidth + "px; "
                    + "-fx-min-height: " + btnHeight + "px; "
                    + "-fx-max-height: " + btnHeight + "px; "
